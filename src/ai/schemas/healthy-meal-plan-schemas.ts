...
export const GenerateHealthyMealPlanInputSchema = z.object({
  ...
  dietPreference: z.enum(['Vegetarian', 'Non-Vegetarian', 'Eggetarian']).describe('The dietary preference of the user.'),
...
const MealSchema = z.object({
    type: z.string().describe("Type of meal, e.g., 'Breakfast', 'Lunch', 'Dinner'"),
...
const DailyMealPlanSchema = z.object({
    ...
    meals: z.array(MealSchema).describe("An array of meals for the day (Breakfast, Lunch, Dinner)"),
